...
if __name__ == "__main__":
    ...
    # User inputs
    csv_file = input("\033[37mLabels file [ \033[90m.csv \033[37m] : \033[0m")
    pcap_file = input("\033[37mCapture file [ \033[90m.pcap \033[37m] : \033[0m")
    destination_input = input("\033[37mDestination folder \033[0m[ \033[90moptional, press enter for current directory\033[0m ] : ").strip()
    output_name = input(f"\033[37mOutput file name [ \033[90mwithout .csv\033[37m ] : \033[0m")

    # Set destination to None if not provided
    destination = destination_input if destination_input else None

    print("\033[90mStarting the computation...\n\033[0m")

    # Load the flows with their labels from the .csv file
    flow_labels = load_flow_labels(csv_file)
    if flow_labels is None:
        print(f"\033[1;91mError 🔥\n\033[0;90mThe .csv file does not contain valid labels\n\033[0m")
    else:
        packet_labeler(flow_labels, pcap_file, output_name, destination) 