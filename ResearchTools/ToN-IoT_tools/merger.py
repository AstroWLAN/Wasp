...
def pcap_merging(input_folder=None, destination_folder=None):
    try:
        ...
        if not pcap_files:
            print(f"\033[1;91mError 🔥\n\033[0;90mThere are no .pcap files in the folder\n\033[0m")
            return
            ...
            try:
                ...
                if editcap_result.returncode == 0:
                    ...
                    if editcap_result.stderr:
                        print(f"\033[1;91mError 🔥\n\033[0;90m{editcap_result.stderr.strip()}\n\033[0m")
        ...
        if result.returncode == 0:
            ...
            if "appears to have been cut short" in result.stderr or "truncated" in result.stderr.lower():
                print(f"\033[1;93mWarning ⚠️\n\033[0;90mSome packets appear to be truncated or corrupted but merging step has been completed\n\033[0m")
                print(f"\033[90mMerged file saved as {output_file}\n\033[0m")
            else:
                # Handle catastrophic failures
                print(f"\033[1;91mError 🔥\n\033[0;90mFailed to merge .pcap files\n\033[0m")
                if result.stderr:
...
def merger(input_folder=None, destination_folder=None):
    ...
    if choice == '1':
        ...
        print(f"\033[1;91mError 🔥\n\033[0;90mSelect a valid option from the menu\n\033[0m")
